...
-- 8. REALTIME SECURITY
-- =============================================
-- Remove profiles from realtime publication if it exists
ALTER PUBLICATION supabase_realtime DROP TABLE IF EXISTS public.profiles;

-- Ensure only safe tables are published
ALTER PUBLICATION supabase_realtime ADD TABLE public.food_listings;
ALTER PUBLICATION supabase_realtime ADD TABLE public.claims;  
ALTER PUBLICATION supabase_realtime ADD TABLE public.notifications;

-- 9. SIGNUP SECURITY ENHANCEMENTS
-- =============================================
-- Update handle_new_user function with better security
...
AS $$
BEGIN
  -- Rate limiting: Check if too many signups from same IP in last hour
  -- (This would require additional IP tracking table in production)
...
-- 10. CREATE RATE LIMITING TABLE FOR SIGNUP PROTECTION
-- =============================================
